                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-earth-600 mt-1">{source.waterType}</p>
                        </div>
              ...
              <div className="glass-card p-6 sticky top-24">
                {selectedDistrictData ? (
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between py-2">
                          ...
                          <span className="font-mono font-medium text-water-600">
                            {sources.find(s => s.id === selectedDistrictData.mainSource)?.name}
                          </span>
                        </div>
                      </div>
                          ...
                          {selectedSourceData.servesAreas.length > 5 && (
                            ...
                            >
                              {expandedAreas ? (
                                ...
                                <>+{selectedSourceData.servesAreas.length - 5} dalších <ChevronDown className="h-3 w-3" /></>
                              )}
                            </button>
                          )}
                        </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-earth-600 font-medium mb-2">Vyberte lokalitu</p>
